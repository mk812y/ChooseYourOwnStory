...
let story = Story(pages: [
    StoryPage( //0
        ...
        You enter a local baking completition at the country fair 🎪. It's a beautiful summer day and you are exited! When you enter the room, you look around to see ten identical stations.
    ...
    StoryPage( // 3
        ...
        StoryPage( // 21
            ...
            """,
            choices: [
                Choice(text: "It’s in the shape of a rainbow.", destination: 20),
                Choice(text: "It has multicolored candies on the outside.", destination: 3),
                Choice(text: "It has marshmallow clouds.", destination: 7),
            ]
        )
])
